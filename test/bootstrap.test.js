...
before(async function Before() {
  ...
  // restricted admin API key used by the release CI to publish Gladys versions
  process.env.GLADYS_VERSION_API_KEY =
    'versionkeytesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttest';
  process.env.STRIPE_SECRET_KEY = 'test';
  process.env.STRIPE_ENDPOINT_SECRET = 'test';
  process.env.STARTER_KIT_TRACKING_SECRET = 'starter-kit-tracking-secret-test';
