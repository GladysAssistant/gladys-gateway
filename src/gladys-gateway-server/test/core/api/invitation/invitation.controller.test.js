...
describe('POST /invitations', () => {
  it('should send invitation', () => request(TEST_BACKEND_APP)
    .post('/invitations')
  ...
  it('should not send invitation, wrong email', () => request(TEST_BACKEND_APP)
    .post('/invitations')
    .set('Accept', 'application/json')
    .set('Authorization', configTest.jwtAccessTokenDashboard)
    .send({
...
describe('POST /invitations/accept', () => {
  it('should accept invitation', () => request(TEST_BACKEND_APP)
  ...
  it('should not accept invitation, not found hash', () => request(TEST_BACKEND_APP)
    .post('/invitations/accept')
    .set('Accept', 'application/json')
    .set('Authorization', configTest.jwtAccessTokenDashboard)
    .send({
  ...
  it('should not accept invitation, missing data', () => request(TEST_BACKEND_APP)
    .post('/invitations/accept')
    .set('Accept', 'application/json')
    .set('Authorization', configTest.jwtAccessTokenDashboard)
    .send({
...
describe('GET /invitations/:id', () => {
  it('should get invitation', () => request(TEST_BACKEND_APP)
...
describe('POST /invitations/:id/revoke', () => {
  it('should revoke invitation', () => request(TEST_BACKEND_APP)
