...
describe('POST /open-api-keys', () => {
  it('should create a new open api key', () => request(TEST_BACKEND_APP)
    .post('/open-api-keys')
    .send({
      name: 'My new api key',
    })
  ...
  it('should not create a new open api key (missing name)', () => request(TEST_BACKEND_APP)
    .post('/open-api-keys')
    .set('Accept', 'application/json')
    .set('Authorization', configTest.jwtAccessTokenDashboard)
    .expect('Content-Type', /json/)
...
describe('GET /open-api-keys', () => {
  it('should get list of existing api key', () => request(TEST_BACKEND_APP)
    .get('/open-api-keys')
    .set('Accept', 'application/json')
    .set('Authorization', configTest.jwtAccessTokenDashboard)
    .expect('Content-Type', /json/)
...
describe('DELETE /open-api-keys/:id', () => {
  it('should revoke api key', () => request(TEST_BACKEND_APP)
...
describe('PATCH /open-api-keys/:id', () => {
  it('should update name api key', () => request(TEST_BACKEND_APP)
