...
async function getQuotaForAccount(limiters, accountId) {
  const [text, image] = await Promise.all([
    getQuotaForLimiter(limiters.textLimiter, accountId, MAX_TEXT_REQUESTS),
    getQuotaForLimiter(limiters.imageLimiter, accountId, MAX_IMAGE_REQUESTS),
  ]);
