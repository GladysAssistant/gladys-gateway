...
describe('POST /v1/api/event/:open-api-key', function() {
  it('should refuse access, invalid API key', function() {
  ...
  it('should return 404 instance not found', function() {
    return request(TEST_BACKEND_APP)
...
describe('POST /v1/api/message/:open-api-key', function() {
  it('should refuse access, invalid API key', function() {
    return request(TEST_BACKEND_APP)
