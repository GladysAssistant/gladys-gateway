        ...
        <div class="col-md">
          <div class="" style={{ height: '100%' }}>
            <div class="card-body">
              ...
              <p class="card-text">
                My name is <a href="https://twitter.com/pierregillesl">Pierre-Gilles Leymarie</a>,
                I'm an indie maker, and I'm working on this open-source project Gladys since 2013,
                for completely free 👨‍💻
              </p>

              <p>
                The Gladys Gateway is the first product on Gladys that is hosted online. It means
                that each month, I have to pay servers to make this product run.
              </p>
              <p>
                This product respects your privacy: Everything is end-to-end encrypted, I'm not
                selling any of your data (since I don't see it), I'm not putting ads, I'm not spying
                on you.
              </p>
              <p>
