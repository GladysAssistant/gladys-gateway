    ...
    request(TEST_BACKEND_APP)
      ...
      .then((response) => {
        should.deepEqual(response.body, {
          ...
          ecdsa_public_key: 'public-key',
          rsa_fingerprint:
            '43:a4:6f:1d:08:1d:27:01:30:e2:21:0a:1d:e5:9f:97:15:de:03:33:07:d0:68:ed:c6:5a:33:5b:27:e9:5d:3d',
          ecdsa_fingerprint:
            '43:a4:6f:1d:08:1d:27:01:30:e2:21:0a:1d:e5:9f:97:15:de:03:33:07:d0:68:ed:c6:5a:33:5b:27:e9:5d:3d',
        });
      }));
...
describe('GET /instances/users', () => {
  it('should return list of users in instance with their public keys', () =>
    request(TEST_BACKEND_APP)
      .get('/instances/users')
      .set('Accept', 'application/json')
