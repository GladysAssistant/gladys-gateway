...
const DeviceRow = ({ children, ...props }) => {
  ...
  if (props.deviceType.type === 'binary') {
    return (<BinaryDeviceType deviceType={props.deviceType} roomIndex={props.roomIndex} deviceTypeIndex={props.deviceTypeIndex} updateValue={props.updateValue} />);
  }
  
  // if not, we return the multilevel component
  return (<MultilevelDeviceType deviceType={props.deviceType} roomIndex={props.roomIndex} deviceTypeIndex={props.deviceTypeIndex} updateValue={props.updateValue} />);
};
