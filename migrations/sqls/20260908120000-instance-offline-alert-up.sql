...
-- disconnect in websocket, and warns the users by email when their instance has been
...
-- Per user opt-in, with the delay after which the "instance offline" email is sent.
ALTER TABLE t_user ADD COLUMN instance_offline_alert_enabled boolean NOT NULL DEFAULT false;
ALTER TABLE t_user ADD COLUMN instance_offline_alert_delay_in_minutes integer NOT NULL DEFAULT 60;
...
ALTER TABLE t_user ADD COLUMN instance_offline_alert_sent_at timestamptz;
